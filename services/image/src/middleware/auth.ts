...
export function attachAuth(
  ...
  // Extract claims from API Gateway event (Lambda Web Adapter passes via x-amzn-request-context header)
  // For RestApi (API Gateway v1), authorizer is at requestContext.authorizer
